...
mongo_client = MongoClient('mongodb://admin:adminpassword@192.168.18.196:27017/')
...
def borrar_anuncio(coche_id):
    ...
    return render_template("anuncios.html",
                        ...
                        usuario_compro_coche=usuario_compro_coche, active_page="anuncios")
...
def mis_compras():
    ...
    for compra in compras:
        ...
        # Obtener los coches comprados por el usuario
        conn = get_mariadb_connection()  # Conectar a MariaDB
